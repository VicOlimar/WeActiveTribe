  ...
  async find(
    ...
    try {
      ...
      if (error.response) {
        ...
        throw new Error(
          'No pudimos recuperar tu lista de reservas, por favor intenta de nuevo en unos momentos.',
        );
      }
    }
  }
  ...
  async create(
    ...
    try {
      ...
      if (error.response) {
        ...
        throw new Error(
          'Ocurrió un error al realizar tu reserva, no se ha consumido ninguno de tus créditos.',
        );
      }
    }
  }
  ...
  async delete(reservation: Reservation): Promise<Reservation> {
    try {
      ...
      if (error.response) {
        ...
        throw new Error(
          'Ocurrió un problema al obtener tu historial de compras.',
        );
      }
    }
  }
