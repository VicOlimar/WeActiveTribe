  ...
  return (
    <footer className={`app-footer ${className}`}>
      <Row>
        ...
        <Col xs={6} lg={1}>
          <a href='https://www.instagram.com/weactivetribe' target='_blank' rel="noopener noreferrer"><img src={Instagram} className='app-footer__instagram' alt='instagram logo' /></a>
        </Col>
        <Col xs={12} lg={9}>
