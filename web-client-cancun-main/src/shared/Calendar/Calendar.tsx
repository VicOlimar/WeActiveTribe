  ...
  return (
    <div className='calendar'>
      ...
      <CreditSelection
        ...
        description={studio && studio.slug === 'online' ? '¿Estás listo para cumplir tus metas? ¡Bienvenido a nuestra nueva normalidad, We HIIT online!' : 'Compra el plan que más se acomode a tu ritmo, y ¡Prepárate para no parar!'}
        plans={filteredPlans}
        onClick={onPlanClick}
