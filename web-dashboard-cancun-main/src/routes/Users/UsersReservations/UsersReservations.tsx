            ...
            return this.state.reservations.map(reservation => {
                ...
                return (
                    lesson ? <tr>
                        ...
                        <td>{lesson.starts_at ? moment(lesson.starts_at).utcOffset('-05:00').format('DD [de] MMMM [del] YYYY') : ''}</td>
                        <td>{lesson.starts_at ? moment(lesson.starts_at).utcOffset('-05:00').format('hh:mm a') : ''}</td>
