      ...
      return purchases.map(purchase => {
        ...
        return (
          <tr>
            ...
            <td className='purchase__table__td'>{created_at ? moment(created_at).utcOffset('-05:00').format(DATE_FORMAT) : ''}</td>
            <td className='purchase__table__td'>{expires_at ? moment(expires_at).utcOffset('-05:00').format(DATE_FORMAT) : ''}</td>
