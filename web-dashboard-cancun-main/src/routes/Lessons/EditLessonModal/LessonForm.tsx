...
const LessonForm = (props: Props) => {
    ...
    const initialValues = {
        ...
        start_hour: (parseInt(moment(props.lesson!.starts_at).utcOffset('-05:00').format("HH")) >= 12) ?
            parseInt(moment(props.lesson!.starts_at).subtract(12, 'h').utcOffset('-05:00').format("HH")) :
            parseInt(moment(props.lesson!.starts_at).utcOffset('-05:00').format("HH")),
        start_minutes: moment(props.lesson!.starts_at).format('mm'),
        community: props.lesson ? props.lesson.community : false,
        scheduleUnit: moment(props.lesson!.ends_at).utcOffset('-05:00').format("HH") >= 12 ? 'pm' : 'am',
