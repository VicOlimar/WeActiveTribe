...
class PlanService extends BaseService {
    ...
    async purchase(id: number, card_id: string, chargeUnique: boolean = false, code: string): Promise<PlanPurcharseResponse | string> {
        ...
        try {
            ...
            if (error.response) {
                ...
                throw new Error('Ocurrió un error con tu tarjeta, no se hizo ningún cargo, por favor intenta de nuevo o intenta con otra tarjeta.');
            }
